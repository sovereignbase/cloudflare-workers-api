  ...
  static ingest(message) {
    ...
    switch (decoded.kind) {
      case "iceServers": {
        ...
        if (id !== "string" || !Object.hasOwn(detail, "iceServers") || detail.iceServers !== false && !Array.isArray(detail.iceServers))
          return;
      ...
      case "checkoutStatus": {
        const { id, detail } = decoded;
        if (id !== "string" || !Object.hasOwn(detail, "checkoutStatus") || detail.checkoutStatus !== false && detail.checkoutStatus !== "paid" && detail.checkoutStatus !== "unpaid" && detail.checkoutStatus !== "no_payment_required")
          return;
        return void this.eventTarget.dispatchEvent(
      ...
      case "invoiceStatus": {
        const { id, detail } = decoded;
        if (id !== "string" || !Object.hasOwn(detail, "invoiceStatus") || detail.invoiceStatus !== false && detail.invoiceStatus !== null && detail.invoiceStatus !== "draft" && detail.invoiceStatus !== "open" && detail.invoiceStatus !== "paid" && detail.invoiceStatus !== "uncollectible" && detail.invoiceStatus !== "void")
          return;
        return void this.eventTarget.dispatchEvent(
